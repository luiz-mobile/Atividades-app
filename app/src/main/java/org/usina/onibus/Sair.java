...
public class Sair extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                new FirebaseAuth.AuthStateListener() {
                    ...
                    public void onAuthStateChanged(@androidx.annotation.NonNull FirebaseAuth firebaseAuth) {
                        ...
                        if (user == null) {
                            ...
                            startActivity(
                                    new Intent (Sair.this, Login_usuario.class));
                            finish();
                        }
                    }
                };
        ...
        voltar.setOnClickListener(
                new View.OnClickListener() {
                    public void onClick(View v) {
                        Intent it = new Intent(Sair.this, Login_usuario.class);
                        startActivity(it);
                    }
                });
                                        ...
                                        .addOnCompleteListener(
                                                new OnCompleteListener<Void> () {
                                                    ...
                                                    public void onComplete(
                                                            @androidx.annotation.NonNull Task<Void> task) {
            ...
            new FirebaseAuth.AuthStateListener() {
                ...
                public void onAuthStateChanged(@androidx.annotation.NonNull FirebaseAuth firebaseAuth) {
                    ...
                    if (user == null) {
                        ...
                        startActivity(new Intent(Sair.this, Login_usuario.class));
                        finish();
                    } else {
                        setDataToView(user);
                    }
